...
-- =====================================================
-- Problème : La fonction ne mettait pas à jour profiles.auth_password
-- Conséquence : La reconnexion automatique échouait après la première connexion
...
-- Vérification
SELECT 
  'Fonction corrigée: internal_set_personal_credentials' as status,
  'La fonction met maintenant à jour profiles.auth_password' as description;
